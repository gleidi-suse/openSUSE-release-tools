...
def do_staging(self, subcmd, opts, *args):
    ...
    Usage:
        ...
        osc staging list [--review-filter] [--supersede] [--adi-details]
    ...
    with OBSLock(opts.apiurl, opts.project, reason=cmd, needed=needed) as lock:
        ...
        if cmd == 'check':
            ...
            ListCommand(api).perform(review_filter=opts.review_filter, supersede=opts.supersede, adi_details=opts.adi_details)
        elif cmd == 'lock':
